...
export default function MapComponent() {
    ...
    const myUserId = 2; // TODO: Replace with real user id from auth
                ...
                {nearbyUsers.map(user => {
                    ...
                    return (
                        <div key={user.user_id}
                            ...
                            <img src={user.avatar_url || "/images/icon.png"} alt="avatar"
                            ...
                            {dist <= 10 ? (
                                ...
                                <span style={{
                                    fontSize: 12,
                                    color: "#aaa"
                                }}>{dist < 1000 ? `${dist.toFixed(1)}m` : `${(dist / 1000).toFixed(2)}km`}</span>
                            )}
                        </div>
                    );
                })}
